          ...
          children: [
            ...
            Container(
              ...
              child: Column(children: [
                if (UserDataBase.userDetails.userWeight == null)
                  SizedBox(
                    height: 60,
                    child: textField(
                        ...
                        onPressed: () async {
                          ...
                          await UserDataBase().setUserWeight(
                            ...
                            SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (value) {
                                  if (value.length >= 2) {
                                    if (value.length > 2)
                                      minsController.text = minsController.text
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        setState(() {
                          ...
                          workoutsTime.add(
                              minsController.text + '.' + secController.text);
                              ...
                              title: Row(
                                children: [
                                  ...
                                  Text(workoutsTime[index],
                                      style: GoogleFonts.zillaSlab(
                                          fontSize: 17, color: primaryGreen)),
                                  SizedBox(
                                    width: 15,
                                  )
                                ],
                      ...
                      onPressed: () async {
                        for (int i = 0; i < workoutsDone.length; i++) {
                          ...
                          var calories = double.parse(workoutsTime[i]) *
                              (workouts[workoutsDone[i]]! * 3.5 * weight) /
                              200;
