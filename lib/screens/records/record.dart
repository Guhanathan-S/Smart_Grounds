...
class _RecordsState extends State<Records> {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: StreamBuilder(
            stream: database.ref.child('records').onValue,
            builder:
              ...
              RecordsModel data =
                  RecordsModel.fromJson(snapShot.data!.snapshot.value);
              gymList = data.gymEquipments!;
              cricketList = data.sportsItems!.cricket ?? [];
              volleyBallList = data.sportsItems!.volleyBall ?? [];
              footBallList = data.sportsItems!.footBall ?? [];
              tennisList = data.sportsItems!.tennis ?? [];
              badmintonList = data.sportsItems!.badminton ?? [];
